...
export function FrigorificosProductsPage() {
    ...
    <div className="bg-white pt-32 pb-12">
      <div className="container">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold mb-4">Etiquetas para Frigoríficos</h1>
          <div className="max-w-4xl mx-auto">
            <img 
              src="https://imgur.com/QNSzc9l.jpg" 
              alt="Etiquetas para Frigoríficos"
              className="w-full h-[400px] object-cover rounded-lg shadow-lg mb-8"
            />
          </div>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Soluções especializadas para identificação de produtos em frigoríficos, 
            com etiquetas resistentes a baixas temperaturas e alta durabilidade.
          </p>
        </div>
