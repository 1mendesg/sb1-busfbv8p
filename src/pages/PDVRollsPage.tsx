...
import { CheeseLabelsModal } from '../components/CheeseLabelsModal';
...
export function PDVRollsPage() {
  ...
  return (
    <div className="bg-white pt-32 pb-12">
      <div className="container">
        <h1 className="text-4xl font-bold text-center mb-12">Bobinas PDV</h1>
